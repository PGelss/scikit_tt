...
xi_exact = fpu_coefficient_tensor(number_of_oscillators)
...
for i in range(snapshots_min, snapshots_max + snapshots_step, snapshots_step):
    ...
    [x, y] = mdl.fermi_pasta_ulam(number_of_oscillators, i)
...
for j in range(5):
    ...
    if exp == -11:
        ...
        plt.semilogy(x_values[:index_mat], rel_errors[1 + j, :index_mat],
