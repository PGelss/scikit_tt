...
basis_list = []
for i in range(5):
    basis_list.append([tdt.constant_function(2 * i), tdt.periodic_gauss_function(2 * i, -2, 0.8),
                       tdt.periodic_gauss_function(2 * i, 1, 0.5)])
    basis_list.append([tdt.constant_function(2 * i + 1), tdt.periodic_gauss_function(2 * i + 1, -0.5, 0.8),
